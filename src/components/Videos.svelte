  ...
  <section class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-x-2 gap-y-8 md:grid-cols-2">
      ...
      <YouTubeEmbed hasCaption videoId="D35ypLnPmbU">
        ...
        <p class="description">
          <em
            >Conceived after the 2015 Paris terrorist attacks and 2016 Brussels bombings,
            <strong>which is sometimes known as</strong>
            explores the different ways people react to tragedy. Abrupt sound shifts facilitate transitions between those
            responses, while the material is refreshed in multiple iterations as new contexts and perspectives are layered
            on.
          </em>
        </p>
      </YouTubeEmbed>
      <YouTubeEmbed hasCaption videoId="d-2NmqQ2Fyg">
        ...
        <p class="description">
          <em>
            Born of a love for grammar,
            <strong>JFK and Stalin Weren’t Strippers</strong>
            plays with the impact of intra-sentence punctuation (e.g. comma, semi-colon, em dash) on the rhythm of language.
            Phrase manipulation is inspired by those impacts, while lines of gesture are influenced by the presence and absence
            of each dancer.
          </em>
        </p>
      </YouTubeEmbed>
